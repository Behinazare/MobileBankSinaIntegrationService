/**
 * StartProcessInstanceRequestBean.java
 *
...
public class StartProcessInstanceRequestBean  implements java.io.Serializable {
    private ProcessParameterValueBean[] parameters;

    private String processDefinitionId;

    public StartProcessInstanceRequestBean() {
    }
    ...
    /**
     * Gets the parameters value for this StartProcessInstanceRequestBean.
     * 
     * @return parameters
     */
    ...
    /**
     * Sets the parameters value for this StartProcessInstanceRequestBean.
     * 
     * @param parameters
     */
    ...
    /**
     * Gets the processDefinitionId value for this StartProcessInstanceRequestBean.
     * 
    ...
    /**
     * Sets the processDefinitionId value for this StartProcessInstanceRequestBean.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof StartProcessInstanceRequestBean)) return false;
        StartProcessInstanceRequestBean other = (StartProcessInstanceRequestBean) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(StartProcessInstanceRequestBean.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.yaghut.modern.tosan.com/", "startProcessInstanceRequestBean"));
