...
public class ActionType implements java.io.Serializable {
    ...
    public static final ActionType CREDIT = new ActionType(_CREDIT);
    public static final ActionType DEBIT = new ActionType(_DEBIT);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.yaghut.modern.tosan.com/", "actionType"));
    }
    /**
