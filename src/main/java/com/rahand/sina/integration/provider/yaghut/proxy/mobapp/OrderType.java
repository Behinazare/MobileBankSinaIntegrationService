...
public class OrderType implements java.io.Serializable {
    ...
    public static final OrderType ASCENDING = new OrderType(_ASCENDING);
    public static final OrderType DESCENDING = new OrderType(_DESCENDING);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.yaghut.modern.tosan.com/", "orderType"));
    }
    /**
