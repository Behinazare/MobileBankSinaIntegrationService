...
public class TermType implements java.io.Serializable {
    ...
    public static final TermType DAILY = new TermType(_DAILY);
    public static final TermType WEEKLY = new TermType(_WEEKLY);
    public static final TermType MONTHLY = new TermType(_MONTHLY);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.yaghut.modern.tosan.com/", "termType"));
    }
    /**
