/**
 * ChequeBookServiceResponseBean.java
 *
...
public class ChequeBookServiceResponseBean  implements java.io.Serializable {
    private com.rahand.sina.integration.provider.yaghut.proxy.mobapp.CommissionResultInfoBean commissionResultInfo;

    public ChequeBookServiceResponseBean() {
    }
    ...
    /**
     * Gets the commissionResultInfo value for this ChequeBookServiceResponseBean.
     * 
    ...
    /**
     * Sets the commissionResultInfo value for this ChequeBookServiceResponseBean.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChequeBookServiceResponseBean)) return false;
        ChequeBookServiceResponseBean other = (ChequeBookServiceResponseBean) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChequeBookServiceResponseBean.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.yaghut.modern.tosan.com/", "chequeBookServiceResponseBean"));
