...
public class ERequestStatus implements java.io.Serializable {
    ...
    public static final ERequestStatus REGISTERED = new ERequestStatus(_REGISTERED);
    public static final ERequestStatus PENDING = new ERequestStatus(_PENDING);
    public static final ERequestStatus CANCELED = new ERequestStatus(_CANCELED);
    public static final ERequestStatus DISAPPROVED = new ERequestStatus(_DISAPPROVED);
    public static final ERequestStatus APPROVED = new ERequestStatus(_APPROVED);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.yaghut.modern.tosan.com/", "eRequestStatus"));
    }
    /**
