...
public class DepositPaymentResponse extends BaseResponse {
    ...
    @Builder
    public DepositPaymentResponse(boolean error, String errorMessage, String extraErrorData, boolean sessionExpired, String extraInfo, BigDecimal amount, String rrn, String trackNumber, String trackerId, LocalDateTime transactionDate, String persianTransactionDate, Long epochTime, String defaultReceipt) {
