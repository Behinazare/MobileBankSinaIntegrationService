...
public class DigitalCreditConfirmPaymentRequest extends BaseRequest {
    ...
    public DigitalCreditConfirmPaymentRequest() {
    }

    @Builder
    public DigitalCreditConfirmPaymentRequest(String userId, DigitalCreditProviderDossierInfo digitalCreditProviderDossierInfo, String paymentId, DigitalCreditPaymentType digitalCreditPaymentType) {
        super(userId);
