...
public class SayadChequeReceiverDto extends BaseDto {
    ...
    public SayadChequeReceiverDto() {
    }

    @Builder
    public SayadChequeReceiverDto(String name, String identityId, String pervasiveId, PersonalityType personalityType) {
        this.name = name;
