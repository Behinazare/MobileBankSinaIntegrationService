...
public class InquirySayadChequeByHolderResponse extends BaseResponse {
    ...
    private List<SayadChequeHolderDto> holders;
    ...
    private SayadChequeAllowedAcceptAction sayadChequeAllowedAcceptAction;

    public InquirySayadChequeByHolderResponse() {
    }

    @Builder
    public InquirySayadChequeByHolderResponse(boolean error, String errorMessage, String extraErrorData, boolean sessionExpired, String extraInfo, String seriesNumber, String serialNumber, String sayadId, String reasonCode, String sourceIban, String bankCode, String branchCode, String description, Currency currency, LocalDateTime dueDate, String persianDueDate, BigDecimal amount, List<SayadChequeHolderDto> holders, SayadChequeType sayadChequeType, SayadChequeStatus sayadChequeStatus, SayadChequeGuaranteeStatus sayadChequeGuaranteeStatus, SayadChequeBlockStatus sayadChequeBlockStatus, SayadChequeLockStatus sayadChequeLockStatus, SayadChequeMedia sayadChequeMedia, SayadChequeAllowedAcceptAction sayadChequeAllowedAcceptAction) {
        ...
        this.sayadChequeAllowedAcceptAction = sayadChequeAllowedAcceptAction;
    }
    ...
    public List<SayadChequeHolderDto> getHolders() {
        return holders;
    }

    public void setHolders(List<SayadChequeHolderDto> holders) {
        this.holders = holders;
    }
    ...
    public SayadChequeAllowedAcceptAction getSayadChequeAllowedAcceptAction() {
        return sayadChequeAllowedAcceptAction;
    }

    public void setSayadChequeAllowedAcceptAction(SayadChequeAllowedAcceptAction sayadChequeAllowedAcceptAction) {
        this.sayadChequeAllowedAcceptAction = sayadChequeAllowedAcceptAction;
    }
}
