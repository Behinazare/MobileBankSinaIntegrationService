...
public class CardTransferResponse extends BaseResponse {
    ...
    @Builder
    public CardTransferResponse(boolean error, String errorMessage, String extraErrorData, boolean sessionExpired, String extraInfo, BigDecimal amount, String rrn, String trackNumber, String trackerId, LocalDateTime transactionDate, String persianTransactionDate, Long epochTime, String sourceCard, String destinationCard, String destinationBankName, PaymentTransactionStatus paymentTransactionStatus, String senderFullName, String receiverFullName, String defaultReceipt, String title, String information) {
    ...
    public String getReceipt() {
        ...
        receiptMap.put("شماره کارت مقصد", BankUtil.maskCardPan(destinationCard));
        receiptMap.put("نام صاحب کارت مقصد", receiverFullName);
